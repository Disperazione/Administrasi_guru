...
@section('main')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="form" action="{{route('admin.kompetensi_dasar.update',$bidang->id)}}" method="POST">
                @method('PUT')
                @csrf
                 {{-- datatenagapendidik --}}
            <div class="row">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input id="mapel" name="mapel" type="text" class="form-control" value="{{$bidang->mapel}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input id="kelas" name="kelas" type="text" class="form-control" value="{{$bidang->kelas}}">
                              <div class="invalid-feedback">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input id="jam_pelajaran" name="jam_pelajaran" type="text" class="form-control" value="{{$bidang->jam_pelajaran}}">
                              <div class="invalid-feedback">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input disabled id="total_waktu_jam_pelajaran" name="total_waktu_jam_pelajaran" type="text" class="form-control" value="{{$bidang->total_waktu_jam_pelajaran}}">
                              <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <select type="text" name="jurusan[]" id="jurusan" class="form-control @error('id_jurusan') is-invalid @endif" multiple="multiple" data-id="{{ $id_jurusan }}">
                                    <option value="">-- Pilih Jurusan --</option>
                                    @foreach ($jurusanAll as $key => $item)
            ...
            {{-- card --}}
            <input type="hidden" id="kompetensi_dasar" name="" value="{{count($kompetensi_dasar)}}">
            <div class="fields_komda">
                @if (count($kompetensi_dasar) > 1)
                        <div class="card card-primary" style="box-shadow: 0 4px 15px 0 rgba(0,0,0,0.2);">
                            <div class="card-header">
                                <h4>KD</h4>
                                <input type="hidden" name="oldKD[]" value="{{$kompetensi_dasar[0]->id}}">
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="kd_pengetahuan" name="kd_pengetahuan[]" type="text"  class="form-control input_kd_pengetahuan" value="{{$kompetensi_dasar[0]->kd_pengetahuan}}" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="kd_keterampilan" name="kd_keterampilan[]" type="text"  class="form-control input_kd_keterampilan" value="{{$kompetensi_dasar[0]->kd_ketrampilan}}">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea id="materi_inti" name="materi_inti[]" type="text"  class="form-control input_materi_inti"  style="height: 90px;">{{$kompetensi_dasar[0]->materi_inti}}</textarea>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="keterangan_pengetahuan" name="keterangan_pengetahuan[]" type="text" class="form-control input_keterangan_pengetahuan" value="{{$kompetensi_dasar[0]->keterangan_pengetahuan}}" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="keterangan_keterampilan" name="keterangan_keterampilan[]" type="text"  class="form-control input_keterangan_keterampilan" value="{{$kompetensi_dasar[0]->keterangan_ketrampilan}}" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="durasi" name="durasi[]" type="text"  class="form-control input_durasi" value="{{$kompetensi_dasar[0]->durasi}}" >
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="jam_pelajaran" name="jam_pelajaran[]" type="text"  class="form-control jam_pelajaran" value="{{$kompetensi_dasar[0]->jam_pertemuan}}" >
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="pertemuan" name="pertemuan[]" type="text"  class="form-control input_pertemuan"   value="{{$kompetensi_dasar[0]->pertemuan}}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="semester" name="semester[]" class="form-control input_semester">
                                            ...
                                            <option value="Ganjil" {{ $kompetensi_dasar[0]->semester == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                                            <option value="Genap" {{ $kompetensi_dasar[0]->semester == 'Genap' ? 'selected' : '' }}>Genap</option>
                                        </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  id="semester_kd" name="semester_kd[]" type="text"  class="form-control input_semester_kd"  value="{{$kompetensi_dasar[0]->semester_kd}}" >
                    ...
                    @for ($i = 1; $i < count($kompetensi_dasar); $i++)
                    <div class="card card-primary" style="box-shadow: 0 4px 15px 0 rgba(0,0,0,0.2);">
                        <div class="card-header">
                            <h4>KD</h4>
                            <input type="hidden" name="oldKD[]" value="{{$kompetensi_dasar[$i]->id}}">
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="kd_pengetahuan" name="kd_pengetahuan[]" type="text"  class="form-control input_kd_pengetahuan" value="{{$kompetensi_dasar[$i]->kd_pengetahuan}}">
                                ...
                                <div class="form-group col-sm-4">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input id="kd_keterampilan" name="kd_keterampilan[]" type="text"  class="form-control input_kd_keterampilan"  value="{{$kompetensi_dasar[$i]->kd_ketrampilan}}">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="materi_inti" name="materi_inti[]" type="text"  class="form-control input_materi_inti" style="height: 90px;"> {{$kompetensi_dasar[$i]->materi_inti}}</textarea>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="keterangan_pengetahuan" name="keterangan_pengetahuan[]" type="text" class="form-control input_keterangan_pengetahuan" value="{{$kompetensi_dasar[$i]->keterangan_pengetahuan}}">
                                ...
                                <div class="form-group col-sm-4">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input id="keterangan_keterampilan" name="keterangan_keterampilan[]" type="text" class="form-control input_keterangan_keterampilan"  value="{{$kompetensi_dasar[$i]->keterangan_ketrampilan}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="durasi" name="durasi[]" type="text"  class="form-control input_durasi" value="{{$kompetensi_dasar[$i]->durasi}}" >
                                                <div class="invalid-feedback d-none invalid_durasi"> 
                                                     Durasi  tidak boleh kosong  
                                                </div>  
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="jam_pelajaran" name="jam_pelajaran[]" type="text"  class="form-control jam_pelajaran" value="{{$kompetensi_dasar[$i]->jam_pertemuan}}" >
                                                <div class="invalid-feedback d-none invalid_jam_pelajaran"> 
                                                    Jam Pelajaran   tidak boleh kosong  
                                                </div>  
                                            </div>
                            ...
                            <div class="row">
                              <div class="form-group col-sm-2">
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="pertemuan" name="pertemuan[]" type="text"  class="form-control input_pertemuan" value="{{$kompetensi_dasar[$i]->pertemuan}}" >
                                ...
                                <div class="form-group col-sm-4">
                                  ...
                                  <div class="input-group">
                                   ...
                                   <select id="semester" name="semester[]" class="form-control input_semester">
                                      <option selected>Lihat Lebih Lanjut</option>
                                      <option value="Ganjil" {{ $kompetensi_dasar[$i]->semester == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                                      <option value="Genap" {{ $kompetensi_dasar[$i]->semester == 'Genap' ? 'selected' : '' }}>Genap</option>
                                    </select>
                              ...
                              <div class="form-group col-sm-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="semester_kd" name="semester_kd[]" type="text"  class="form-control input_semester_kd" value="{{$kompetensi_dasar[$i]->semester_kd}}"  >
                    ...
                    @endfor
                @else
                    @for ($i = 0; $i < count($kompetensi_dasar); $i++)
...
<script>
    ...
    $('#button').click(function (e) {
            ...
            if (!validasi_jurusan() && !validasi_kelas() && !
                validasi_jam_pelajaran() && !validasi_total_waktu_jam_pelajaran() 
                ...
                validasi_total_waktu_jam_pelajaran();
            ...
            function validasi_jam_pelajaran() {
                // buat ngidung ada berapa yang kena validasi
                count_erorr = [];
                if (!jamPelajaran) {
                    $('#jam_pelajaran').addClass('is-invalid'); // Ad class is-invalid
                    $('#jam_pelajaran').closest('div').find('.invalid-feedback').removeClass(
                        'd-none'
                    ); // cari div terdekat dan cari class nya find = cari lalu REMOVE class d-none
                    count_erorr += 1
                } else {
                    $('#jam_pelajaran').removeClass('is-invalid').removeClass('is-invalid');
                    $('#jam_pelajaran').closest('div').find('.invalid-feedback').addClass(
                        'd-none'
                    ); // cari div terdekat dan cari class nya find = cari lalu add class d-none
                }
                // return panjang dari collection atau array
