...
<body>
    <div>
        ...
        <div  style="margin-left: 10px;">
            ...
            <p class="font5" style="font-size: 14px">Pada bagian ini, cantumkan data pribadi tenaga pendidik serta mencantumkan matapelajaran 
                yang di ampu.</p>
        </div>
        <div style="margin-left: 10px;">
        ...
        <div style="margin-left: 25px;font-size:14px;">
                ...
                <p class="font5" style="">
                    No.Telp/Fax/E-mail<span style="margin-left: 91px;">
                                            :&nbsp; Telp:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>khjasdkahdkah</u>&nbsp;&nbsp;&nbsp;
                                            Fax:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>1234950</u> <br>
                                            <div style="margin-left: 240px"> HP:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>124676868534</u></div>
            ...
            <table class="font5" border="1" style="border-collapse:collapse;">
                ...
                <tbody style="text-align: center">
                      ...
                      <tr>
                        ...
                        <td> :</td>
                        <td>Pemrograman Berorientasi Objek XII</td>
                    </tr>
                    <tr>
                        <td>Jam Pelajaran</td>
                        <td> :</td>
                        <td>128 JP {@ 45 menit}</td>
                    </tr>
        ...
        <div style="margin-left: -20px;margin-top:20px;">
            <table class="font5" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr style="background-color: rgb(182, 208, 211);">
                        <th colspan="9">Semester Ganjil</th>
                    </tr>
        ...
        <div style="margin-left: -20px;margin-top:20px;">
            <table class="font5" border="1" style="border-collapse:collapse;">
                <thead>
                    <tr style="background-color: rgb(182, 208, 211);">
                        <th colspan="9">Semester Genap</th>
                    </tr>
                    <tr style="background-color: rgb(182, 208, 211);font-size:12px;">
                        <th style="padding:10px;">KD</th>
                        <th style="padding:10px;">Kompetensi Dasar (Pengetahuan)</th>
            ...
            <table class="font5" border="1" style="border-collapse:collapse;width:700px;">
                ...
                <tbody style="font-size:14px;">
                        ...
                        <tr>
                          ...
                          <tr>
                            <td>3</td>
                            <td>Siswa dapat membuat aplikasi berbasis web dengan framework MVC studi kasus soal UKK/Sistem informasi sekolah</td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>4</td>
                            <td>Siswa dapat membuat aplikasi dengan reporting dengan format tabular dengan parameter inputan seperti daily, montly ,by date
                            </td>
                            <td></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td>8</td>
                            <td>Siswa dapat membuat laporan/dokumentasi karya aplikasi dalam bentuk manual book/dokumentasi software</td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>9</td>
        ...
        <div style="margin-left: 10px;margin-top:20px;">
            <table class="font5" border="1" style="border-collapse:collapse;width:700px;">
                ...
                <tbody style="font-size:14px;">
                        ...
                        <tr>
                          <td>1</td>
                          <td>Siswa dapat membuat User interface dengan library bootstrap</td>
                          <td></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Siswa dapat membuat aplikasi berbasis oop dan mvc yang dapat mengelola / view audio dan video </td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>3</td>
                            <td>Siswa dapat membuat aplikasi sistem informasi studi kasus soal UKK RPL/sistem informasi sekolah dengan framework MVC.</td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>4</td>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        ...
        <div style="margin-left: 10px;margin-top:20px;">
            <table class="font5" border="1" style="border-collapse:collapse;width:700px;">
                ...
                <tbody style="font-size:14px;">
                        ...
                        <tr>
                          <td>1</td>
                          <td>Portofolio karya code program di link github</td>
                        </tr>
                        <tr>
                            <td>2</td>
        ...
        <div style="margin-left: 10px;margin-top:20px;">
            <table class="font5" border="1" style="border-collapse:collapse;font-weight:light;font-size:14px;width:700px;">
                <tbody>
                    <tr>
